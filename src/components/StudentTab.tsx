...
import { student, subjects, recentGrades, skillTree, weeklyData, weekDays } from "@/data/students";
import { getMMRGradient, getGradeColor, getSkillLabel } from "@/lib/utils";
          ...
          <div className="flex flex-col sm:flex-row sm:items-end gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r ${getMMRGradient(student.mmr)} text-white shadow-lg`}>
